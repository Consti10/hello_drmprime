...
_LDLIBS=-lavcodec -lavfilter -lavutil -lavformat -ldrm -lpthread #-lwiringPi
...
hello_drmprime: hello_drmprime.cpp drmprime_out.cpp extra.h drmprime_out.h MMapFrame.h
